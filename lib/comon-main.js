...
function main() {
    ...
    if (getChapter()) {
        ...
        // var url = "https://image-comic.pstatic.net/mobilewebimg/730656/"+getChapter()+"/"+dtb_deathticket(getChapter())[0]+"_";
        var url = "730656_"+getChapter()+"/"+dtb_deathticket(getChapter())[0]+"_";
